...
def parse_args(extra_args_provider=None, defaults={},
    ...
    if 'SLURM_PROCID' in os.environ:
        # args.world_size = int(os.environ["MY_NTASKS"])
        # args.local_rank = int(os.environ["SLURM_LOCALID"])
        # args.rank = int(os.environ['MY_PROCID']) + args.local_rank
...
def _add_training_args(parser):
    ...
    group.add_argument('--cpu-offloading', action='store_true')
    group.add_argument('--output', type=str, default=None)
    group.add_argument('--use-new-schedule', action='store_true')
    group.add_argument('--overlap-data-parallel-allreduce', action='store_true')
    group.add_argument('--forward-backward-compute-time-ratio', type=float, default=0.0)
    group.add_argument('--overlap-pipeline-parallel-send-recv', action='store_true')
    group.add_argument('--use-gloo-for-pipeline-parallel-broadcast', action='store_true')
    group.add_argument('--use-gloo-for-pipeline-parallel-send-recv', action='store_true')
